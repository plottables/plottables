...
import type { CoreAbi, CoreAbiInterface } from "../CoreAbi";
...
export class CoreAbi__factory {
  static readonly abi = _abi;
  static createInterface(): CoreAbiInterface {
    return new utils.Interface(_abi) as CoreAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CoreAbi {
    return new Contract(address, _abi, signerOrProvider) as CoreAbi;
  }
}
