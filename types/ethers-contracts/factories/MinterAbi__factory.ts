...
import type { MinterAbi, MinterAbiInterface } from "../MinterAbi";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract GenArt721CoreV2",
        name: "",
        type: "address",
      },
    ],
...
export class MinterAbi__factory {
  static readonly abi = _abi;
  static createInterface(): MinterAbiInterface {
    return new utils.Interface(_abi) as MinterAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MinterAbi {
    return new Contract(address, _abi, signerOrProvider) as MinterAbi;
  }
}
